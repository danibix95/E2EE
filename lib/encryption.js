...
class EncryptionLayer {
  ...
  static wrapKey(sbox, pk = null) {
    ...
    return crypto.subtle.wrapKey(
        "raw",
        ck,
        pk ? pk : userPublicKeys.get(encryptionObject), // by default use own PK, otherwise use the provided one ->ths is used when it is necessary to share the wrapped key
        {
          name: "RSA-OAEP",
   ...
   * @return {Promise.<null>}
   */
  static unwrapKey(wrappedKey, sbox) {
